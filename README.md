...
[![GoDoc](https://godoc.org/github.com/CN-HYC/fabric-sdk-go?status.svg)](https://godoc.org/github.com/CN-HYC/fabric-sdk-go)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/CN-HYC/fabric-sdk-go)](https://goreportcard.com/report/github.com/CN-HYC/fabric-sdk-go)
...
```bash
go get github.com/CN-HYC/fabric-sdk-go
```
...
SDK documentation can be viewed at [GoDoc](https://godoc.org/github.com/CN-HYC/fabric-sdk-go).
...
```bash
git clone https://github.com/CN-HYC/fabric-sdk-go.git
```
